...
<!--        &lt;!&ndash;<div class="input-wrapper" v-if="showItemId === item.id">&ndash;&gt;-->
<!--        &lt;!&ndash;<el-input class="gray-bg-input"&ndash;&gt;-->
<!--        &lt;!&ndash;v-model="inputComment"&ndash;&gt;-->
<!--        &lt;!&ndash;type="textarea"&ndash;&gt;-->
<!--        &lt;!&ndash;:rows="3"&ndash;&gt;-->
<!--        &lt;!&ndash;autofocus&ndash;&gt;-->
<!--        &lt;!&ndash;placeholder="写下你的评论">&ndash;&gt;-->
<!--        &lt;!&ndash;</el-input>&ndash;&gt;-->
<!--        &lt;!&ndash;<div class="btn-control">&ndash;&gt;-->
<!--        &lt;!&ndash;<span class="cancel" @click="cancel">取消</span>&ndash;&gt;-->
<!--        &lt;!&ndash;<el-button class="btn" type="success" round @click="commitComment">确定</el-button>&ndash;&gt;-->
<!--        &lt;!&ndash;</div>&ndash;&gt;-->
<!--        &lt;!&ndash;</div>&ndash;&gt;-->
